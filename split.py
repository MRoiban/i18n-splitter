...
def split_i18n_file(input_file, source_language, target_language, lines_per_file=50):
    ...
    for piece_number in range(total_pieces):
        ...
        piece_content = [f"translate the entire i18n file i'm giving you, make sure you translate it all from {source_language} to {target_language}:"] + lines[start_line:end_line]
